      ...
      prototype[name] = typeof prop[name] == "function" &&
        ...
        (function(name, fn){
          return function() {
            ...
            // Este metodo solo es contemporaneo
...
function initCanvas() {
  ...
  // creacion de los menus de sprite
...
function drawStartScreen() {
  fillCenteredText("SPACESHIP-JOHAN-GAME", CANVAS_WIDTH/2, CANVAS_HEIGHT/2.75, '#FFFFFF', 36);
  fillBlinkingText("Presione enter para jugar!", CANVAS_WIDTH/2, CANVAS_HEIGHT/2, 500, '#FFFFFF', 36);
}
...
function resize() {
  ...
  var h = window.innerHeight;
    ...
    // calculando la escala de funciones 
